...
A lightweight C++ command-line wrapper around [llama.cpp](https://github.com/ggml-org/llama.cpp) for running local Llama models. Enter a prompt, get a response — no server, no Python, no dependencies beyond a C++ compiler.
